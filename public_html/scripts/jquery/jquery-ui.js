    ...
    var slider = $.widget("ui.slider", $.ui.mouse, {
        ...
        _createHandles: function() {
            var i, handleCount,
                    ...
                    handle = "<span class='ui-slider-handle ui-state-default ui-corner-all' style='z-index:1000'></span>",
                    disabledhandle = "<span class='ui-slider-handle ui-slider-handle-disabled ui-state-default ui-corner-all' style='background: #1F3461;border:none; height: 20px;width: 20px;top: -9px;z-index:100'></span>",
                    boundarydisabledhandle = "<span class='ui-slider-handle ui-slider-handle-disabled ui-state-default ui-corner-all disable-boundary' style='background: #D2D6DF;border:none; height: 20px;width: 20px;top: -9px;z-index:500'></span>",
                    handles = [];
...
//            }
            for (i = existingHandles.length; i < handleCount; i++) {
                if (i === 0 || i === 4) {
                    handles.push(disabledhandle);
                } else if (i === 1 || i === 3) {
                    handles.push(boundarydisabledhandle);
                } else if (i == 2) {
                    handles.push(handle);
                }
            }
