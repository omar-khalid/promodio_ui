/**
 * This angularJS directive helps in playing audio
 * 
 * @package argus.mediaplayer
 * @copyright 2015 Argusoft India Ltd.
 * 
 * @author prabhat
 */
/*Example:- 
 * <audio media-player="mediaPlayer" data-playlist="audioPlaylist"></audio>
 * 
 * mediaPlayer      :     is the variable name that will help to control the playback of media files
 * audioPlayList    :     is a json array containing objects in the following format
 *                        audioPlayList=[{src:'songs/song1.mp3', type: 'audio/mpeg'},{src:'songs/song2.ogg', type: 'audio/ogg'}]
 * 
 * 
 * important methods:
 *             mediaPlayer.play()
 *             mediaPlayer.playPause()
 *             mediaPlayer.playPause(index)
 *             mediaPlayer.next()
 *             mediaPlayer.prev()
 *             mediaPlayer.seek(duration)
 *             mediaPlayer.setVolume(<any valu between 0-1>)
 *             mediaPlayer.toggleMute()
 *       
 * important properties:
 *            mediaPlayer.playing           :boolean
 *            mediaPlayer.muted             :boolean
 *            mediaPlayer.formatTime        :ellapsed time
 *            mediaPlayer.formatDuration    :total duration of audio
 *            mediaPlayer.volume            :between 0-1
 *            mediaPlayer.currentTrack      :index
 *            mediaPlayer.loadPercent       :% of song buffered
 *       
 *       
 * 
 */
...
.directive('mediaPlayer', ['$rootScope', '$interpolate', '$timeout', 'mp.throttle', 'mp.playerDefaults',
  function ($rootScope, $interpolate, $timeout, throttle, playerDefaults) {
    ...
    var MediaPlayer = function (element) {
      ...
      $rootScope.mediaPlayer=mediaScope;
      return mediaScope;
    };
